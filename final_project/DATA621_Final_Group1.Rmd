...
am1998_df <- am_df %>% dplyr::filter(yeardes == 1998 & termdes=="Fall") %>% dplyr::select(!c(enroll,yeardes,termdes))
...
am1999_df <- am_df %>% dplyr::filter(yeardes == 1999 & termdes=="Fall") %>% dplyr::select(!c(enroll,yeardes,termdes))
...
```{r}
am2000_df <- am_df %>% dplyr::filter(yeardes == 2000 & termdes=="Fall") %>% dplyr::select(!c(enroll,yeardes,termdes))
...
```{r}
am2001_df <- am_df %>% dplyr::filter(yeardes == 2001 & termdes=="Fall") %>% dplyr::select(!c(enroll,yeardes,termdes))
...
am2002_df <- am_df %>% dplyr::filter(yeardes == 2002 & termdes=="Fall") %>% dplyr::select(!c(enroll,yeardes,termdes))
