...
droppedNODf <- filterOutliers(filterDf, droppedDf, columnNames)

printStats(droppedNODf)
printDensityPlot(droppedNODf)
...
lm3 <- lm(TARGET_WINS ~ . -TEAM_BATTING_H, data=droppedNODf, by=na_flag)
summary(lm3)
