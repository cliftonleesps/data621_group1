...
Looking at another relationship between strike outs (`TEAM_BATTING_SO`) and wins we can see a the strike out data has fewer outliers but not as strong of a negative correlation as one would expect with target wins. 
