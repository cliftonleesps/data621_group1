...
printStats(droppedDf)
#printDensityPlot(droppedDf)
...
The third model will contain the variables from the cleaned dataset with outliers omitted using historic data from the Lahman's Baseball Database. 
