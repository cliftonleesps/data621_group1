...
model1_df <-model_1_aic.eval %>% multi_metric(truth=model_1_aic.eval$target, estimate=model_1_aic.eval$predicted)
...
```{r}
model2_df <-model_2_aic.eval %>% multi_metric(truth=model_2_aic.eval$target, estimate=model_2_aic.eval$predicted)
