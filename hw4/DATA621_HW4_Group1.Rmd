...
transformed_df <- dummy_vars(transformed_df)
```
...
## We should reconsider this viz. Everything looks the same?
-   Observation
-   Observation
...
plot_parent1 <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$SINGLE_PARENT, fill=CAR_CRASH)) +
...
plot_sex <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$MALE, fill=CAR_CRASH), offset = 0.005) +
...
plot_mstatus <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$MARRIED, fill=CAR_CRASH), offset = 0.005) +
...
plot_car_use <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$PRIVATE_USE, fill=CAR_CRASH), offset = 0.005) +
...
plot_red_car <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$CAR_RED, fill=CAR_CRASH), offset = 0.005) +
...
plot_revoked <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$LIC_REVOKED, fill=CAR_CRASH), offset = 0.005) +
...
plot_urbanicity <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$URBAN, fill=CAR_CRASH), offset = 0.005) +
...
plot_education <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$EDUCATION, fill=CAR_CRASH), offset = 0.005) +
...
plot_job <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$JOB, fill=CAR_CRASH), offset = 0.005) +
...
plot_car_type <- ggplot(data = vis_df) +
  geom_mosaic(aes(x = vis_df$CAR_TYPE, fill=CAR_CRASH), offset = 0.005) +
